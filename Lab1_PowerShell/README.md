...
- Create a new file named `DiskAudit.ps1`
...
5. run the scipt one more time and check the logs folder for the output files.
6. Close the script
...
![alt text](image.png)
3. Summarize the main responsibilities of this script in bullet points.
