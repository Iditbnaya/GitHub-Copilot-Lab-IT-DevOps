...
- Sample PowerShell and YAML snippets (created ad hoc with Copilot during the exercises).
...
2. Review [Setup.md](Setup.md) in the root instructions folder to confirm you completed any required organization-specific prerequisites.
...
1. Create a new PowerShell   `Get-ProcessReport.ps1` and type a comment describing a script that summarizes top processes by CPU.
